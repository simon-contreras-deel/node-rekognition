...
const fs = require('fs');
const debug = require('debug')('rekognition-node:S3');
...
module.exports = class S3 {
   ...
   * @param {string} folder
   */
  getS3FullPath(filePath, folder = 'rekognition-node-folder/') {
    ...
    if (VALID_FORMATS.indexOf(extension) !== -1) return folder + fileName;
